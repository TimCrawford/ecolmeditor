    ...
    return function(t) {
        ...
        ([function(t, e, r) {
                ...
                var a = function() {
                        function t(t) {
                            var r = this;
                            this.tempos = [], this.timeSignatures = [], this.keySignatures = [], this.meta = [], this.name = "", i.set(this, 480), t && (i.set(this, t.header.ticksPerBeat), t.tracks.forEach((function(t) {
                    ...
                    u = function() {
                        function t(t) {
                            ...
                            t && (t instanceof ArrayBuffer && (t = new Uint8Array(t)), (r = a.parseMidi(t)).tracks.forEach((function(t) {
                                ...
                                (r.tracks)), this.header = new s.Header(r), this.tracks = [], t && (this.tracks = r.tracks.map((function(t) {
                ...
                var i, a, o = (i = /^([a-g] {    1    } ( ? : b | # | x | bb) ? )(- ? [0 - 9] + ) / i,
                    a = {
                        cbb: -2,
                        cb: -1,
                        c: 0,
