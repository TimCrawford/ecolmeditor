...
//			AdjustKey(midi.header.keySignatures[0].scale == "major"? majorKeys[midi.header.keySignatures[0].key] : minorKeys[midi.header.keySignatures[0].key], "baroque")
	// FIXME Need to adjust tuning to key-signature here before using
		
console.log("Time Sig: "+timeSigNum+"/"+timeSigDenom)
...
console.log("allnotes has "+allnotes.length+" notes")
...
// 				console.log("{System Break near here!!}")
	...
	tabcode.unshift("");						
	tabcode.unshift("");						
	tabcode.unshift("{Converted from: "+fname+"}");						
